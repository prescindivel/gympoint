...
routes.post('/students/:student_id/help-order', HelpOrderController.create);
...
routes.get('/help-orders', HelpOrderController.list);
routes.post('/help-orders/:help_order_id/answer', HelpOrderController.answer);
